					...
					<div class="w3ls_dresses_grid_left_grid">
						...
						<div class="w3ls_dresses_grid_left_grid_sub">
							<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
							  <div class="panel panel-default">
								...
								<div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
								  <div class="panel-body panel_text">
									<ul>
										<li><a href="<?php echo base_url().'index.php/home/dresses'?>">Dresses</a></li>
										<li><a href="<?php echo base_url().'index.php/home/sweaters'?>">Sweaters</a></li>
										<li><a href="<?php echo base_url().'index.php/home/skirts'?>">Shorts & Skirts</a></li>
										<li><a href="<?php echo base_url().'index.php/home/jeans'?>">Jeans</a></li>
										<li><a href="<?php echo base_url().'index.php/home/shirts'?>">Shirts</a></li>
									</ul>
								  </div>
								</div>
							  </div>
							  <div class="panel panel-default">
								...
								<div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
								   <div class="panel-body panel_text">
									<ul>
										<li><a href="<?php echo base_url().'index.php/home/sandals'?>">Flats</a></li>
										<li><a href="<?php echo base_url().'index.php/home/sandals'?>">Sandals</a></li>
										<li><a href="<?php echo base_url().'index.php/home/sandals'?>">Boots</a></li>
										<li><a href="<?php echo base_url().'index.php/home/sandals'?>">Heals</a></li>
										<li><a href="<?php echo base_url().'index.php/home/sandals'?>">Shirts</a></li>
									</ul>
								  </div>
								</div>
							  </div>
							...
							<ul class="panel_bottom">
								<li><a href="<?php echo base_url().'index.php/home/products'?>">Summer Store</a></li>
								<li><a href="<?php echo base_url().'index.php/home/dresses'?>">New In Clothing</a></li>
								<li><a href="<?php echo base_url().'index.php/home/sandals'?>">New In Shoes</a></li>
								<li><a href="<?php echo base_url().'index.php/home/products'?>">Latest Watches</a></li>
							</ul>
						</div>
					</div>
					<div class="w3ls_dresses_grid_left_grid">
					...
					<div class="w3ls_dresses_grid_right_grid3">
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_dresses">
							<div class="agile_ecommerce_tab_left dresses_grid">
								...
								<h5><a href="<?php echo base_url().'index.php/home/single'?>">Mascara Limited Edition</a></h5>
						...
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_dresses">
							<div class="agile_ecommerce_tab_left dresses_grid">
								...
								<h5><a href="<?php echo base_url().'index.php/home/single'?>">Rossetto Lipstick</a></h5>
								<div class="simpleCart_shelfItem">
						...
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_dresses">
							<div class="agile_ecommerce_tab_left dresses_grid">
								...
								<h5><a href="<?php echo base_url().'index.php/home/single'?>">Ideal Luminous Mousse</a></h5>
								<div class="simpleCart_shelfItem">
					...
					<div class="w3ls_dresses_grid_right_grid3">
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_dresses">
							<div class="agile_ecommerce_tab_left dresses_grid">
								...
								<h5><a href="<?php echo base_url().'index.php/home/single'?>">Golden Analog Watch</a></h5>
								<div class="simpleCart_shelfItem">
						...
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_dresses">
							<div class="agile_ecommerce_tab_left dresses_grid">
								...
								<h5><a href="<?php echo base_url().'index.php/home/single'?>">Silver Analog Watch</a></h5>
								<div class="simpleCart_shelfItem">
					...
					<div class="w3ls_dresses_grid_right_grid3">
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_dresses">
							<div class="agile_ecommerce_tab_left dresses_grid">
								...
								<h5><a href="<?php echo base_url().'index.php/home/single'?>">Golden Alloy Bangles</a></h5>
								<div class="simpleCart_shelfItem">
						...
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_dresses">
							<div class="agile_ecommerce_tab_left dresses_grid">
								...
								<h5><a href="<?php echo base_url().'index.php/home/single'?>">Golden Alloy Chain</a></h5>
								<div class="simpleCart_shelfItem">
